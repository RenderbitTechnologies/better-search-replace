				...
				<table>
					...
					<tr>
						...
						<?php
							...
							if ( is_array( $profiles ) && 0 !== count( $profiles ) ) {

								echo '<select id="bsr_profile" name="bsr_profile">
								...
								printf( '<p>%s <a href="%s">%s</a></p>', __( 'No profiles found.', 'better-search-replace' ), get_admin_url() . 'tools.php?page=better-search-replace', __( 'Click here to create one.','better-search-replace' ) );
							}
						?>
				        </td>
					</tr>
